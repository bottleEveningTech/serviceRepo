...
import { TASK_STATUS_OPTIONS, TaskStatusOptions, typeStatusValueProvider } from '../task.model';
...
@Component({
  ...
  providers: [typeStatusValueProvider]
})
export class TasksListComponent {
  private selectedFilter = signal<string>('all');
  tasksService = inject(TaskServiceToken);
